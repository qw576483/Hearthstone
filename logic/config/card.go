...
var defineCardConfig []*CardConfig = []*CardConfig{
	...
	263: &CardConfig{
		Id:            263,
		Name:          "杀戮命令",
		Desc:          "造成3点伤害。如果你控制一个野兽，则改为造成5点伤害。",
		Mona:          3,
		Damage:        3,
		Quality:       define.CardQualityBase,
		Ctype:         define.CardTypeSorcery,
	...
	273: &CardConfig{
		Id:       273,
		Name:     "战争储备箱",
		Desc:     "随机将一张战士随从牌，法术牌和武器牌分别置入你的手牌。",
		Mona:     3,
		Quality:  define.CardQualityBlue,
		Ctype:    define.CardTypeSorcery,
		Vocation: MakeCardVocation(define.VocationWarrior),
	...
	275: &CardConfig{
		Id:              275,
		Name:            "自然印记",
		Desc:            "抉择：使一个随从获得+4攻击力；或者+4生命值和嘲讽。",
		Mona:            3,
		Quality:         define.CardQualityWhite,
		Ctype:           define.CardTypeSorcery,
		Race:            MakeCardRace(define.CardRaceNatural),
	...
	280: &CardConfig{
		Id:       280,
		Name:     "肯瑞托法师",
		Desc:     "战吼：在本回合中，你使用的下一个奥秘的法力值消耗为（0）点。",
		Mona:     3,
		Damage:   4,
		Hp:       3,
		Quality:  define.CardQualityBlue,
	...
	282: &CardConfig{
		Id:       282,
		Name:     "寒冰屏障",
		Desc:     "奥秘：当你的英雄将要承受致命伤害时，防止这些伤害，并使其在本回合中获得免疫。",
		Mona:     3,
		Quality:  define.CardQualityPurple,
		Ctype:    define.CardTypeSorcery,
		Race:     MakeCardRace(define.CardRaceIce),
	...
	283: &CardConfig{
		Id:       283,
		Name:     "镜像实体",
		Desc:     "奥秘：在你的对手使用一张随从牌后，召唤一个该随从的复制。",
		Mona:     3,
		Quality:  define.CardQualityWhite,
		Ctype:    define.CardTypeSorcery,
		Race:     MakeCardRace(define.CardRaceArcaneSkill),
	...
	285: &CardConfig{
		Id:       285,
		Name:     "扰咒术",
		Desc:     "奥秘：当一个敌方法术以一个随从为目标时，召唤一个1/3的随从并使其成为新的目标。",
		Mona:     3,
		Quality:  define.CardQualityPurple,
		Ctype:    define.CardTypeSorcery,
		Traits:   MakeCardTraits(define.CardTraitsSecret),
	...
	290: &CardConfig{
		Id:       290,
		Name:     "神恩术",
		Desc:     "抽若干数量的牌，直到你的手牌数量等同于你对手的手牌数量。",
		Mona:     3,
		Quality:  define.CardQualityBlue,
		Ctype:    define.CardTypeSorcery,
		Race:     MakeCardRace(define.CardRaceSacred),
	...
	291: &CardConfig{
		Id:       291,
		Name:     "公正之剑",
		Desc:     "在你召唤一个随从后，使其获得+1/+1，这把武器失去1点耐久度。",
		Mona:     3,
		Damage:   1,
		Hp:       5,
		Quality:  define.CardQualityPurple,
	...
	294: &CardConfig{
		Id:       294,
		Name:     "艾德温·范克里夫",
		Desc:     "连击：在本回合中，你每使用一张其他牌，便获得+2/+2。",
		Mona:     3,
		Damage:   2,
		Hp:       2,
		Quality:  define.CardQualityOrange,
	...
	296: &CardConfig{
		Id:       296,
		Name:     "裂颅之击",
		Desc:     "对敌方英雄造成2点伤害；连击：在下个回合将其移回你的手牌。",
		Mona:     3,
		Damage:   2,
		Quality:  define.CardQualityBlue,
		Ctype:    define.CardTypeSorcery,
	...
	300: &CardConfig{
		...
		Quality:  define.CardQualityBase,
		Ctype:    define.CardTypeEntourage,
		Race:     MakeCardRace(define.CardRaceUndead, define.CardRaceBeast),
		Vocation: MakeCardVocation(define.VocationShaman),
		Series:   define.CardSeriseClassic,
	},
	301: &CardConfig{
	...
	304: &CardConfig{
		...
		Ctype:    define.CardTypeEntourage,
		Race:     MakeCardRace(define.CardRaceDevil),
		Traits:   MakeCardTraits(define.CardTraitsOnRelease, define.CardTraitsTaunt),
		Vocation: MakeCardVocation(define.VocationWarlock),
		Series:   define.CardSeriseClassic,
		CanCarry: true,
	},
	305: &CardConfig{
		Id:       305,
		Name:     "虚空恐魔",
		Desc:     "战吼：消灭该随从两侧的随从，并获得他们的攻击力和生命值。",
		Mona:     3,
		Damage:   3,
		Hp:       4,
		Quality:  define.CardQualityBlue,
	...
	326: &CardConfig{
		Id:       326,
		Name:     "精神控制技师",
		Desc:     "战吼：如果你的对手拥有4个或者更多随从，随机获得其中一个的控制权。",
		Mona:     3,
		Damage:   3,
		Hp:       3,
		Quality:  define.CardQualityBlue,
	...
	333: &CardConfig{
		...
		Ctype:    define.CardTypeEntourage,
		Race:     MakeCardRace(define.CardRaceBeast),
		Traits:   MakeCardTraits(define.CardTraitsHighlyToxic),
		Series:   define.CardSeriseClassic,
		CanCarry: true,
	},
	334: &CardConfig{
