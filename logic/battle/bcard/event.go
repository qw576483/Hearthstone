...
func (c *Card) OnBeforeCostHp(dmg int) int                                   { return dmg } // 受伤前
func (c *Card) OnAfterCostHp()                                               {}             // 受伤后
...
func (c *Card) OnNROtherGetTraits(oc iface.ICard) []define.CardTraits     { return nil }   // 其他卡牌获得自己的特质时，返回特质加成
func (c *Card) OnNROtherHeroGetTraits(oh iface.IHero) []define.CardTraits { return nil }   // 获得英雄获得自己的特质时，返回特质加成
