...
namespace UnityGeneralFramework.HotUpdateLogic { 
    public class PatchEventDefine {
        ...
        /// 补丁下载完毕
        /// </summary>
        public class PatchDone : IEventMessage {
            public string Tips;
            public static void SendEventMessage(string tip) {
                var msg = new PatchDone();
                msg.Tips = tip;
                UniEvent.SendMessage(msg);
            }
        }
        ...
        /// 开始加载code
        /// </summary>
        public class LoadCode : IEventMessage {
            public string Tips;
            public static void SendEventMessage(string tip) {
                var msg = new LoadCode();
                msg.Tips = tip;
                UniEvent.SendMessage(msg);
            }
        }
        ...
        /// 加载代码dll错误
        /// </summary>
        public class LoadCodeError : IEventMessage {
            public int ErrorCode;
            public string Tips;
            public static void SendEventMessage(string tip, int code) {
                var msg = new LoadCodeError();
                msg.Tips = tip;
                msg.ErrorCode = code;
                UniEvent.SendMessage(msg);
            }
        ...
        /// 加载Code完毕
        /// </summary>
        public class LoadCodeDone : IEventMessage {
            public string Tips;
            public static void SendEventMessage(string tip) {
                var msg = new LoadCodeDone();
                msg.Tips = tip;
                UniEvent.SendMessage(msg);
            }
        }
